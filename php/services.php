...
<body>
  ...
  <div class="container-fluid ct  " style="margin-top:-30px!important; width:100%!important; padding:30px 0px 0px 0px ;" onmouseover="long()" onmouseout="longout()">
    <?php
  ...
  <div class="container bg-white cont " style="padding-bottom:100px;">
